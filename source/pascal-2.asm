...
.command_go_handler
    ...
    sta vm_base_ptr                                                   ; 83f9: 85 1e       ..
    lda oshwm_high1,x                                                 ; 83fb: bd 07 04    ...
    sta vm_base_ptr + 1                                               ; 83fe: 85 1f       ..
...
.set_up_for_cold_start
    ...
    cpx vm_stack_ptr                                                  ; 8619: e4 00       ..
    sbc vm_stack_ptr + 1                                              ; 861b: e5 01       ..
    bcc c8655                                                         ; 861d: 90 36       .6
    ldx vm_pc                                                         ; 861f: a6 02       ..
    cpx l0027                                                         ; 8621: e4 27       .'
    lda vm_pc + 1                                                     ; 8623: a5 03       ..
    sbc l0028                                                         ; 8625: e5 28       .(
    bcc c8655                                                         ; 8627: 90 2c       .,
    cpx vm_stack_ptr                                                  ; 8629: e4 00       ..
    lda vm_pc + 1                                                     ; 862b: a5 03       ..
    sbc vm_stack_ptr + 1                                              ; 862d: e5 01       ..
...
; compiler ROM paged in and needs to re-enter the command prompt loop via *FX163,192,2.
    ...
    sta vm_base_ptr                                                   ; 878a: 85 1e       ..
    lda #>compiler_bytecode_start                                     ; 878c: a9 86       ..
    sta vm_base_ptr + 1                                               ; 878e: 85 1f       ..
...
.interpreter_start
    ...
    lda vm_base_ptr                                                   ; 87b4: a5 1e       ..
    sta vm_pc                                                         ; 87b6: 85 02       ..
    lda vm_base_ptr + 1                                               ; 87b8: a5 1f       ..
    sta vm_pc + 1                                                     ; 87ba: 85 03       ..
...
.bytecode_opcode_37_handler
    lda operand_size_minus_1_table - 51,x                             ; 883a: bd 01 a7    ...
...
.bytecode_opcode_03_handler
    lda operand_size_minus_1_table,x                                  ; 8850: bd 34 a7    .4.
    sta l004c                                                         ; 8853: 85 4c       .L
    jsr set_l0008_to_vm_pc_plus_1                                     ; 8855: 20 9c 9a     ..
...
.push_y_bytes_at_l0008_to_vm_stack
    ...
    sta vm_stack_ptr                                                  ; 8895: 85 00       ..
    bcc c889b                                                         ; 8897: 90 02       ..
    inc vm_stack_ptr + 1                                              ; 8899: e6 01       ..
.c889b
    txa                                                               ; 889b: 8a          .
    rts                                                               ; 889c: 60          `
...
.bytecode_opcode_04_handler
    ...
    lda #2                                                            ; 88c1: a9 02       ..
    jsr set_l0008_to_vm_pc_plus_a                                     ; 88c3: 20 aa 9a     ..
    ldy #&ff                                                          ; 88c6: a0 ff       ..
.loop_c88c8
    iny                                                               ; 88c8: c8          .
    lda (l0008),y                                                     ; 88c9: b1 08       ..
    sta (vm_stack_ptr),y                                              ; 88cb: 91 00       ..
...
.bytecode_opcode_39_handler
    lda operand_size_minus_1_table - 56,x                             ; 88e5: bd fc a6    ...
...
.bytecode_opcode_06_handler
    lda operand_size_minus_1_table - 5,x                              ; 88fb: bd 2f a7    ./.
    sta l004c                                                         ; 88fe: 85 4c       .L
    jsr set_l0008_to_vm_pc_plus_1                                     ; 8900: 20 9c 9a     ..
...
.sub_c892d
    clc                                                               ; 892d: 18          .
    lda vm_stack_ptr                                                  ; 892e: a5 00       ..
    sbc l004c                                                         ; 8930: e5 4c       .L
    sta vm_stack_ptr                                                  ; 8932: 85 00       ..
    sta l000a                                                         ; 8934: 85 0a       ..
    lda vm_stack_ptr + 1                                              ; 8936: a5 01       ..
    sbc #0                                                            ; 8938: e9 00       ..
    sta vm_stack_ptr + 1                                              ; 893a: 85 01       ..
...
.bytecode_opcode_3f_handler
    lda operand_size_minus_1_table - 59,x                             ; 893f: bd f9 a6    ...
...
.bytecode_opcode_15_handler
    lda operand_size_minus_1_table - 17,x                             ; 895b: bd 23 a7    .#.
...
.bytecode_opcode_17_handler
    ...
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 8977: 20 68 9a     h.
    ldx #2                                                            ; 897a: a2 02       ..
    bne c8966                                                         ; 897c: d0 e8       ..
.bytecode_opcode_40_handler
.bytecode_opcode_41_handler
    lda operand_size_minus_1_table - 64,x                             ; 897e: bd f4 a6    ...
    jsr sub_c87f9                                                     ; 8981: 20 f9 87     ..
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 8984: 20 68 9a     h.
    ldx #3                                                            ; 8987: a2 03       ..
...
.bytecode_opcode_27_handler
    ...
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 8990: 20 68 9a     h.
...
.sub_c89a6
    ...
    clc                                                               ; 89a9: 18          .
    lda vm_stack_ptr                                                  ; 89aa: a5 00       ..
    sta l000e                                                         ; 89ac: 85 0e       ..
    adc l0012                                                         ; 89ae: 65 12       e.
    sta vm_stack_ptr                                                  ; 89b0: 85 00       ..
    lda vm_stack_ptr + 1                                              ; 89b2: a5 01       ..
    sta l000f                                                         ; 89b4: 85 0f       ..
    adc l0013                                                         ; 89b6: 65 13       e.
    sta vm_stack_ptr + 1                                              ; 89b8: 85 01       ..
...
.bytecode_opcode_f3_handler
    jsr subtract_8_from_vm_stack_ptr                                  ; 8aca: 20 1d 9a     ..
    lda #1                                                            ; 8acd: a9 01       ..
...
.bytecode_opcode_4f_handler
    ...
    jsr set_l0008_to_vm_pc_plus_2                                     ; 8af9: 20 a0 9a     ..
    ldx #3                                                            ; 8afc: a2 03       ..
...
.sub_c8b88
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 8b88: 20 68 9a     h.
.sub_c8b8b
    ldy #3                                                            ; 8b8b: a0 03       ..
.loop_c8b8d
...
.loop_c8d9b
    ...
    and (vm_stack_ptr),y                                              ; 8d9d: 31 00       1.
...
.bytecode_opcode_be_handler
    jsr subtract_4_from_vm_stack_ptr                                  ; 8e01: 20 19 9a     ..
    lda (vm_stack_ptr),y                                              ; 8e04: b1 00       ..
    and #1                                                            ; 8e06: 29 01       ).
    bpl c8e46                                                         ; 8e08: 10 3c       .<
.bytecode_opcode_84_handler
    jsr subtract_2_from_vm_stack_ptr                                  ; 8e0a: 20 15 9a     ..
    lda (vm_stack_ptr),y                                              ; 8e0d: b1 00       ..
    iny                                                               ; 8e0f: c8          .
    and (vm_stack_ptr),y                                              ; 8e10: 31 00       1.
    bpl c8e4a                                                         ; 8e12: 10 36       .6
.bytecode_opcode_85_handler
    jsr subtract_2_from_vm_stack_ptr                                  ; 8e14: 20 15 9a     ..
    lda (vm_stack_ptr),y                                              ; 8e17: b1 00       ..
    iny                                                               ; 8e19: c8          .
    ora (vm_stack_ptr),y                                              ; 8e1a: 11 00       ..
    bpl c8e4a                                                         ; 8e1c: 10 2c       .,
.bytecode_opcode_86_handler
    jsr subtract_1_from_vm_stack_ptr                                  ; 8e1e: 20 11 9a     ..
    lda (vm_stack_ptr),y                                              ; 8e21: b1 00       ..
    eor #1                                                            ; 8e23: 49 01       I.
...
.bytecode_opcode_59_handler
    ...
    jsr subtract_2_from_vm_stack_ptr                                  ; 8e2d: 20 15 9a     ..
    lda (vm_stack_ptr),y                                              ; 8e30: b1 00       ..
    iny                                                               ; 8e32: c8          .
    cmp (vm_stack_ptr),y                                              ; 8e33: d1 00       ..
.c8e35
...
.loop_c8e83
    ...
    eor #&ff                                                          ; 8e85: 49 ff       I.
    and (vm_stack_ptr),y                                              ; 8e87: 31 00       1.
...
.bytecode_opcode_61_handler
    ...
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 8ea6: 20 68 9a     h.
    jsr c9a8a                                                         ; 8ea9: 20 8a 9a     ..
    jsr subtract_4_from_vm_stack_ptr                                  ; 8eac: 20 19 9a     ..
...
.bytecode_opcode_81_handler
    jsr subtract_32_from_vm_stack_ptr_and_copy_to_l000a               ; 8efc: 20 70 9a     p.
    jsr sub_c9af1                                                     ; 8eff: 20 f1 9a     ..
    jmp c8f10                                                         ; 8f02: 4c 10 8f    L..

.bytecode_opcode_83_handler
    jsr subtract_32_from_vm_stack_ptr_and_copy_to_l000a               ; 8f05: 20 70 9a     p.
...
.loop_c8f6e
    ...
    and (vm_stack_ptr),y                                              ; 8f7e: 31 00       1.
    sta (vm_stack_ptr),y                                              ; 8f80: 91 00       ..
...
.bytecode_opcode_95_handler
    ...
    jsr subtract_1_from_vm_stack_ptr                                  ; 932c: 20 11 9a     ..
    ldx vm_stack_ptr                                                  ; 932f: a6 00       ..
    ldy vm_stack_ptr + 1                                              ; 9331: a4 01       ..
    lda #1                                                            ; 9333: a9 01       ..
...
.bytecode_opcode_92_handler
    lda operand_size_minus_1_table - 145,x                            ; 9418: bd a3 a6    ...
    sta l004c                                                         ; 941b: 85 4c       .L
    jsr sub_c91a8                                                     ; 941d: 20 a8 91     ..
    lda #0                                                            ; 9420: a9 00       ..
    ldy #3                                                            ; 9422: a0 03       ..
.loop_c9424
    sta (vm_stack_ptr),y                                              ; 9424: 91 00       ..
    dey                                                               ; 9426: 88          .
...
.bytecode_opcode_9d_handler
    ...
    jsr subtract_a_from_vm_stack_ptr_and_copy_to_l000a                ; 947b: 20 72 9a     r.
    jmp c9490                                                         ; 947e: 4c 90 94    L..

.bytecode_opcode_a2_handler
.bytecode_opcode_a3_handler
    jsr subtract_4_from_vm_stack_ptr_and_copy_to_l000a                ; 9481: 20 68 9a     h.
...
.c9510
    ...
    adc #9                                                            ; 9515: 69 09       i.
    sta vm_stack_ptr                                                  ; 9517: 85 00       ..
    lda l0019                                                         ; 9519: a5 19       ..
    sta l001b                                                         ; 951b: 85 1b       ..
    adc #0                                                            ; 951d: 69 00       i.
    sta vm_stack_ptr + 1                                              ; 951f: 85 01       ..
    lda #4                                                            ; 9521: a9 04       ..
    rts                                                               ; 9523: 60          `
...
; TODO: This looks vaguely like some kind of table-based branch.
.bytecode_opcode_7c_handler
    jsr set_l0008_to_vm_pc_plus_1                                     ; 955b: 20 9c 9a     ..
    ldx #2                                                            ; 955e: a2 02       ..
.c9560
    ldy #0                                                            ; 9560: a0 00       ..
...
.sub_c95d0
    ...
    clc                                                               ; 95db: 18          .
    lda vm_stack_ptr                                                  ; 95dc: a5 00       ..
    adc l0012                                                         ; 95de: 65 12       e.
    sta l062c                                                         ; 95e0: 8d 2c 06    .,.
    lda vm_stack_ptr + 1                                              ; 95e3: a5 01       ..
    ...
    ldx vm_stack_ptr                                                  ; 9605: a6 00       ..
    lda vm_stack_ptr + 1                                              ; 9607: a5 01       ..
...
.c9614
    clc                                                               ; 9614: 18          .
    lda vm_stack_ptr                                                  ; 9615: a5 00       ..
    adc l004a                                                         ; 9617: 65 4a       eJ
    sta vm_stack_ptr                                                  ; 9619: 85 00       ..
    lda vm_stack_ptr + 1                                              ; 961b: a5 01       ..
    adc l004b                                                         ; 961d: 65 4b       eK
    sta vm_stack_ptr + 1                                              ; 961f: 85 01       ..
    lda #4                                                            ; 9621: a9 04       ..
    rts                                                               ; 9623: 60          `

.bytecode_opcode_7d_handler
    lda l001a                                                         ; 9624: a5 1a       ..
    sta vm_stack_ptr                                                  ; 9626: 85 00       ..
    lda l001b                                                         ; 9628: a5 1b       ..
    sta vm_stack_ptr + 1                                              ; 962a: 85 01       ..
    ldy #6                                                            ; 962c: a0 06       ..
    lda (l001a),y                                                     ; 962e: b1 1a       ..
    tax                                                               ; 9630: aa          .
    dey                                                               ; 9631: 88          .
    lda (l001a),y                                                     ; 9632: b1 1a       ..
    sta vm_pc + 1                                                     ; 9634: 85 03       ..
    dey                                                               ; 9636: 88          .
    ...
    dey                                                               ; 9645: 88          .
    lda (vm_stack_ptr),y                                              ; 9646: b1 00       ..
    sta l001b                                                         ; 9648: 85 1b       ..
    dey                                                               ; 964a: 88          .
    lda (vm_stack_ptr),y                                              ; 964b: b1 00       ..
...
.c973d
    clc                                                               ; 973d: 18          .
    adc vm_base_ptr                                                   ; 973e: 65 1e       e.
    sta vm_pc                                                         ; 9740: 85 02       ..
    txa                                                               ; 9742: 8a          .
    adc vm_base_ptr + 1                                               ; 9743: 65 1f       e.
    sta vm_pc + 1                                                     ; 9745: 85 03       ..
    lda #0                                                            ; 9747: a9 00       ..
    rts                                                               ; 9749: 60          `
...
.c9761
    ...
    txa                                                               ; 9766: 8a          .
    adc vm_pc + 1                                                     ; 9767: 65 03       e.
    sta vm_pc + 1                                                     ; 9769: 85 03       ..
    lda #0                                                            ; 976b: a9 00       ..
    rts                                                               ; 976d: 60          `
...
.add_a_to_vm_stack_ptr
    ...
    inc vm_stack_ptr + 1                                              ; 9a05: e6 01       ..
.c9a07
    rts                                                               ; 9a07: 60          `

.sub_c9a08
    ldy #&1f                                                          ; 9a08: a0 1f       ..
    jsr subtract_32_from_vm_stack_ptr_and_copy_to_l000a               ; 9a0a: 20 70 9a     p.
.sub_c9a0d
    lda #&20 ; ' '                                                    ; 9a0d: a9 20       .
    bne subtract_a_from_vm_stack_ptr                                  ; 9a0f: d0 16       ..
.subtract_1_from_vm_stack_ptr
    lda #1                                                            ; 9a11: a9 01       ..
    bne subtract_a_from_vm_stack_ptr                                  ; 9a13: d0 12       ..
.subtract_2_from_vm_stack_ptr
    lda #2                                                            ; 9a15: a9 02       ..
    bne subtract_a_from_vm_stack_ptr                                  ; 9a17: d0 0e       ..
.subtract_4_from_vm_stack_ptr
    lda #4                                                            ; 9a19: a9 04       ..
    bne subtract_a_from_vm_stack_ptr                                  ; 9a1b: d0 0a       ..
.subtract_8_from_vm_stack_ptr
    lda #8                                                            ; 9a1d: a9 08       ..
    bne subtract_a_from_vm_stack_ptr                                  ; 9a1f: d0 06       ..
; TODO: dead code?
    lda #&0a                                                          ; 9a21: a9 0a       ..
    bne subtract_a_from_vm_stack_ptr                                  ; 9a23: d0 02       ..
.subtract_16_from_vm_stack_ptr
    lda #&10                                                          ; 9a25: a9 10       ..
.subtract_a_from_vm_stack_ptr
    sta l0014                                                         ; 9a27: 85 14       ..
    sec                                                               ; 9a29: 38          8
    lda vm_stack_ptr                                                  ; 9a2a: a5 00       ..
    sbc l0014                                                         ; 9a2c: e5 14       ..
    sta vm_stack_ptr                                                  ; 9a2e: 85 00       ..
    bcs c9a34                                                         ; 9a30: b0 02       ..
    dec vm_stack_ptr + 1                                              ; 9a32: c6 01       ..
.c9a34
    rts                                                               ; 9a34: 60          `
...
.subtract_4_from_vm_stack_ptr_and_copy_to_l000a
    lda #4                                                            ; 9a68: a9 04       ..
    bne subtract_a_from_vm_stack_ptr_and_copy_to_l000a                ; 9a6a: d0 06       ..
.subtract_5_from_vm_stack_ptr_and_copy_to_l000a
    lda #5                                                            ; 9a6c: a9 05       ..
    bne subtract_a_from_vm_stack_ptr_and_copy_to_l000a                ; 9a6e: d0 02       ..
.subtract_32_from_vm_stack_ptr_and_copy_to_l000a
    lda #&20 ; ' '                                                    ; 9a70: a9 20       .
.subtract_a_from_vm_stack_ptr_and_copy_to_l000a
    sta l0014                                                         ; 9a72: 85 14       ..
    sec                                                               ; 9a74: 38          8
    lda vm_stack_ptr                                                  ; 9a75: a5 00       ..
    sbc l0014                                                         ; 9a77: e5 14       ..
    sta vm_stack_ptr                                                  ; 9a79: 85 00       ..
    sta l000a                                                         ; 9a7b: 85 0a       ..
    lda vm_stack_ptr + 1                                              ; 9a7d: a5 01       ..
    sbc #0                                                            ; 9a7f: e9 00       ..
    sta vm_stack_ptr + 1                                              ; 9a81: 85 01       ..
...
.c9a8c
    ...
    sec                                                               ; 9a8e: 38          8
    lda vm_stack_ptr                                                  ; 9a8f: a5 00       ..
    sbc l0014                                                         ; 9a91: e5 14       ..
    sta l000c                                                         ; 9a93: 85 0c       ..
    lda vm_stack_ptr + 1                                              ; 9a95: a5 01       ..
    sbc #0                                                            ; 9a97: e9 00       ..
    sta l000d                                                         ; 9a99: 85 0d       ..
    rts                                                               ; 9a9b: 60          `

.set_l0008_to_vm_pc_plus_1
    lda #1                                                            ; 9a9c: a9 01       ..
    bne set_l0008_to_vm_pc_plus_a                                     ; 9a9e: d0 0a       ..
.set_l0008_to_vm_pc_plus_2
    lda #2                                                            ; 9aa0: a9 02       ..
    bne set_l0008_to_vm_pc_plus_a                                     ; 9aa2: d0 06       ..
.set_l0008_to_vm_pc_plus_4
    lda #4                                                            ; 9aa4: a9 04       ..
    bne set_l0008_to_vm_pc_plus_a                                     ; 9aa6: d0 02       ..
.set_l0008_to_vm_pc_plus_5
    lda #5                                                            ; 9aa8: a9 05       ..
.set_l0008_to_vm_pc_plus_a
    clc                                                               ; 9aaa: 18          .
    adc vm_pc                                                         ; 9aab: 65 02       e.
    sta l0008                                                         ; 9aad: 85 08       ..
    lda #0                                                            ; 9aaf: a9 00       ..
    adc vm_pc + 1                                                     ; 9ab1: 65 03       e.
...
.sub_c9ab6
    ...
    lda vm_pc + 1                                                     ; 9abd: a5 03       ..
    adc #0                                                            ; 9abf: 69 00       i.
    sta l000b                                                         ; 9ac1: 85 0b       ..
    rts                                                               ; 9ac3: 60          `

.sub_c9ac4
    jsr subtract_2_from_vm_stack_ptr                                  ; 9ac4: 20 15 9a     ..
    ldy #1                                                            ; 9ac7: a0 01       ..
    lda (vm_stack_ptr),y                                              ; 9ac9: b1 00       ..
    sta l000b                                                         ; 9acb: 85 0b       ..
    dey                                                               ; 9acd: 88          .
    lda (vm_stack_ptr),y                                              ; 9ace: b1 00       ..
    sta l000a                                                         ; 9ad0: 85 0a       ..
    rts                                                               ; 9ad2: 60          `

.sub_c9ad3
    jsr subtract_2_from_vm_stack_ptr                                  ; 9ad3: 20 15 9a     ..
    ldy #1                                                            ; 9ad6: a0 01       ..
    lda (vm_stack_ptr),y                                              ; 9ad8: b1 00       ..
    sta l000f                                                         ; 9ada: 85 0f       ..
    dey                                                               ; 9adc: 88          .
    lda (vm_stack_ptr),y                                              ; 9add: b1 00       ..
...
.pull_word_l0008_from_vm_stack
    ...
    dey                                                               ; 9aeb: 88          .
    lda (vm_stack_ptr),y                                              ; 9aec: b1 00       ..
    sta l0008                                                         ; 9aee: 85 08       ..
    rts                                                               ; 9af0: 60          `

.sub_c9af1
    jsr subtract_1_from_vm_stack_ptr                                  ; 9af1: 20 11 9a     ..
    ldy #0                                                            ; 9af4: a0 00       ..
...
.bytecode_opcode_42_handler
    ...
    jsr subtract_a_from_vm_stack_ptr                                  ; 9b14: 20 27 9a     '.
    iny                                                               ; 9b17: c8          .
    lda (vm_pc),y                                                     ; 9b18: b1 02       ..
.sub_c9b1a
    sta l0015                                                         ; 9b1a: 85 15       ..
    ldy #0                                                            ; 9b1c: a0 00       ..
    lda (vm_stack_ptr),y                                              ; 9b1e: b1 00       ..
    sta l0008                                                         ; 9b20: 85 08       ..
    iny                                                               ; 9b22: c8          .
    lda (vm_stack_ptr),y                                              ; 9b23: b1 00       ..
    sta l0009                                                         ; 9b25: 85 09       ..
    iny                                                               ; 9b27: c8          .
    lda (vm_stack_ptr),y                                              ; 9b28: b1 00       ..
    sta l000a                                                         ; 9b2a: 85 0a       ..
    iny                                                               ; 9b2c: c8          .
    lda (vm_stack_ptr),y                                              ; 9b2d: b1 00       ..
...
.c9b42
    ...
    iny                                                               ; 9b44: c8          .
    lda (vm_stack_ptr),y                                              ; 9b45: b1 00       ..
.c9b47
    pha                                                               ; 9b47: 48          H
    ldy l0016                                                         ; 9b48: a4 16       ..
    lda (vm_stack_ptr),y                                              ; 9b4a: b1 00       ..
    ldy #3                                                            ; 9b4c: a0 03       ..
...
.bytecode_opcode_d6_handler
    jsr set_l0008_to_vm_pc_plus_4                                     ; 9bd5: 20 a4 9a     ..
...
.bytecode_opcode_d8_handler
    jsr set_l0008_to_vm_pc_plus_5                                     ; 9bfe: 20 a8 9a     ..
...
.bytecode_opcode_d5_handler
    jsr set_l0008_to_vm_pc_plus_5                                     ; 9c54: 20 a8 9a     ..
...
.bytecode_opcode_d7_handler
    lda #9                                                            ; 9c68: a9 09       ..
    jsr set_l0008_to_vm_pc_plus_a                                     ; 9c6a: 20 aa 9a     ..
...
.sub_c9cb4
    jsr subtract_4_from_vm_stack_ptr                                  ; 9cb4: 20 19 9a     ..
    ldy #3                                                            ; 9cb7: a0 03       ..
.loop_c9cb9
    lda (vm_stack_ptr),y                                              ; 9cb9: b1 00       ..
    bne c9cc4                                                         ; 9cbb: d0 07       ..
    dey                                                               ; 9cbd: 88          .
    bne loop_c9cb9                                                    ; 9cbe: d0 f9       ..
    lda (vm_stack_ptr),y                                              ; 9cc0: b1 00       ..
    clc                                                               ; 9cc2: 18          .
    rts                                                               ; 9cc3: 60          `
...
.bytecode_opcode_f1_handler
    ...
    sta vm_base_ptr                                                   ; 9ccb: 85 1e       ..
    lda vm_pc + 1                                                     ; 9ccd: a5 03       ..
    sta vm_base_ptr + 1                                               ; 9ccf: 85 1f       ..
    lda #0                                                            ; 9cd1: a9 00       ..
    rts                                                               ; 9cd3: 60          `

.bytecode_opcode_ee_handler
    jsr subtract_8_from_vm_stack_ptr                                  ; 9cd4: 20 1d 9a     ..
    ldy #&0c                                                          ; 9cd7: a0 0c       ..
    bne c9ce0                                                         ; 9cd9: d0 05       ..
.bytecode_opcode_ed_handler
    jsr subtract_2_from_vm_stack_ptr                                  ; 9cdb: 20 15 9a     ..
    ldy #9                                                            ; 9cde: a0 09       ..
.c9ce0
    ...
    ldy #8                                                            ; 9ce8: a0 08       ..
    lda (vm_stack_ptr),y                                              ; 9cea: b1 00       ..
    tax                                                               ; 9cec: aa          .
    ldy l0016                                                         ; 9ced: a4 16       ..
    lda (vm_stack_ptr),y                                              ; 9cef: b1 00       ..
    tay                                                               ; 9cf1: a8          .
...
.sub_c9d3b
    jsr subtract_4_from_vm_stack_ptr                                  ; 9d3b: 20 19 9a     ..
    ldy #0                                                            ; 9d3e: a0 00       ..
    lda (vm_stack_ptr),y                                              ; 9d40: b1 00       ..
    sta l0008                                                         ; 9d42: 85 08       ..
    iny                                                               ; 9d44: c8          .
    lda (vm_stack_ptr),y                                              ; 9d45: b1 00       ..
    sta l0009                                                         ; 9d47: 85 09       ..
    rts                                                               ; 9d49: 60          `

.sub_c9d4a
    jsr subtract_4_from_vm_stack_ptr                                  ; 9d4a: 20 19 9a     ..
    ldy #0                                                            ; 9d4d: a0 00       ..
    lda (vm_stack_ptr),y                                              ; 9d4f: b1 00       ..
    sta l0012                                                         ; 9d51: 85 12       ..
    iny                                                               ; 9d53: c8          .
    lda (vm_stack_ptr),y                                              ; 9d54: b1 00       ..
...
.bytecode_opcode_e3_handler
    ...
    asl a                                                             ; a756: 0a          .
    asl a                                                             ; a757: 0a          .
    jsr subtract_a_from_vm_stack_ptr                                  ; a758: 20 27 9a     '.
    dey                                                               ; a75b: 88          .
.loop_ca75c
    lda (vm_stack_ptr),y                                              ; a75c: b1 00       ..
...
.bytecode_opcode_e2_handler
    ...
    lda #&0c                                                          ; a770: a9 0c       ..
    jsr subtract_a_from_vm_stack_ptr                                  ; a772: 20 27 9a     '.
    ldx #4                                                            ; a775: a2 04       ..
.loop_ca777
    lda la786,x                                                       ; a777: bd 86 a7    ...
    tay                                                               ; a77a: a8          .
    lda (vm_stack_ptr),y                                              ; a77b: b1 00       ..
...
.bytecode_opcode_e5_handler
    lda #&10                                                          ; a7a8: a9 10       ..
    tay                                                               ; a7aa: a8          .
    jsr subtract_a_from_vm_stack_ptr                                  ; a7ab: 20 27 9a     '.
    ldx #8                                                            ; a7ae: a2 08       ..
.loop_ca7b0
    dey                                                               ; a7b0: 88          .
    txa                                                               ; a7b1: 8a          .
...
.bytecode_opcode_e6_handler
    ...
    tay                                                               ; a7c5: a8          .
    jsr subtract_a_from_vm_stack_ptr                                  ; a7c6: 20 27 9a     '.
    ldx #&0e                                                          ; a7c9: a2 0e       ..
.loop_ca7cb
    dey                                                               ; a7cb: 88          .
    dey                                                               ; a7cc: 88          .
...
.bytecode_opcode_ec_handler
    jsr subtract_8_from_vm_stack_ptr                                  ; a860: 20 1d 9a     ..
    ldx #3                                                            ; a863: a2 03       ..
.loop_ca865
    lda la882,x                                                       ; a865: bd 82 a8    ...
    tay                                                               ; a868: a8          .
    lda (vm_stack_ptr),y                                              ; a869: b1 00       ..
...
.bytecode_opcode_ef_handler
    jsr subtract_16_from_vm_stack_ptr                                 ; aeb2: 20 25 9a     %.
    ldy #&0f                                                          ; aeb5: a0 0f       ..
.loop_caeb7
    lda (vm_stack_ptr),y                                              ; aeb7: b1 00       ..
...
.loop_caec7
    ...
    sta vm_base_ptr + 1,y                                             ; aec9: 99 1f 00    ...
    dey                                                               ; aecc: 88          .
    cpy #2                                                            ; aecd: c0 02       ..
...
.caf48
    ...
    sty vm_pc + 1                                                     ; af4a: 84 03       ..
    jsr sub_cafd9                                                     ; af4c: 20 d9 af     ..
    stx vm_stack_ptr                                                  ; af4f: 86 00       ..
    sta vm_stack_ptr + 1                                              ; af51: 85 01       ..
...
.cb080
    ...
    lda #&20 ; ' '                                                    ; b08a: a9 20       .
    sta (vm_stack_ptr),y                                              ; b08c: 91 00       ..
    rts                                                               ; b08e: 60          `

.cb08f
    jsr sub_cb34d                                                     ; b08f: 20 4d b3     M.
    inc vm_stack_ptr                                                  ; b092: e6 00       ..
    bne cb09e                                                         ; b094: d0 08       ..
.cb096
    inc vm_stack_ptr + 1                                              ; b096: e6 01       ..
    bne cb09e                                                         ; b098: d0 04       ..
.loop_cb09a
    lda (l0010),y                                                     ; b09a: b1 10       ..
    sta (vm_stack_ptr),y                                              ; b09c: 91 00       ..
.cb09e
    dey                                                               ; b09e: 88          .
...
.sub_cb1a1
    ...
    sbc vm_pc + 1                                                     ; b1a7: e5 03       ..
    rts                                                               ; b1a9: 60          `

.sub_cb1aa
    clc                                                               ; b1aa: 18          .
    lda l003f                                                         ; b1ab: a5 3f       .?
    adc vm_stack_ptr                                                  ; b1ad: 65 00       e.
    tax                                                               ; b1af: aa          .
    lda #0                                                            ; b1b0: a9 00       ..
    adc vm_stack_ptr + 1                                              ; b1b2: 65 01       e.
...
.sub_cb29d
    ...
    clc                                                               ; b2a4: 18          .
    lda vm_stack_ptr                                                  ; b2a5: a5 00       ..
    adc l003f                                                         ; b2a7: 65 3f       e?
    sta l0008                                                         ; b2a9: 85 08       ..
    lda vm_stack_ptr + 1                                              ; b2ab: a5 01       ..
    adc #0                                                            ; b2ad: 69 00       i.
...
.sub_cb34d
    lda vm_stack_ptr                                                  ; b34d: a5 00       ..
    sta l0010                                                         ; b34f: 85 10       ..
    lda vm_stack_ptr + 1                                              ; b351: a5 01       ..
...
.something_to_do_with_finding_cr
    ldx vm_stack_ptr                                                  ; b374: a6 00       ..
    ldy vm_stack_ptr + 1                                              ; b376: a4 01       ..
...
.cb404
    ...
    tax                                                               ; b40f: aa          .
    lda vm_pc + 1                                                     ; b410: a5 03       ..
    sbc l000b                                                         ; b412: e5 0b       ..
    sty vm_pc + 1                                                     ; b414: 84 03       ..
    tay                                                               ; b416: a8          .
    stx l0012                                                         ; b417: 86 12       ..
    sty l0013                                                         ; b419: 84 13       ..
    lda vm_stack_ptr                                                  ; b41b: a5 00       ..
    sbc l0012                                                         ; b41d: e5 12       ..
    sta l000e                                                         ; b41f: 85 0e       ..
    sta vm_stack_ptr                                                  ; b421: 85 00       ..
    lda vm_stack_ptr + 1                                              ; b423: a5 01       ..
    sbc l0013                                                         ; b425: e5 13       ..
    sta l000f                                                         ; b427: 85 0f       ..
    sta vm_stack_ptr + 1                                              ; b429: 85 01       ..
...
.bulk_copy_from_l0000_to_vm_pc
    lda vm_stack_ptr                                                  ; b45c: a5 00       ..
    sta l000a                                                         ; b45e: 85 0a       ..
    lda vm_stack_ptr + 1                                              ; b460: a5 01       ..
    sta l000b                                                         ; b462: 85 0b       ..
    lda vm_pc                                                         ; b464: a5 02       ..
    sta l000e                                                         ; b466: 85 0e       ..
    lda vm_pc + 1                                                     ; b468: a5 03       ..
    sta l000f                                                         ; b46a: 85 0f       ..
    sec                                                               ; b46c: 38          8
    txa                                                               ; b46d: 8a          .
    sbc vm_stack_ptr                                                  ; b46e: e5 00       ..
    stx vm_stack_ptr                                                  ; b470: 86 00       ..
    tax                                                               ; b472: aa          .
    tya                                                               ; b473: 98          .
    sbc vm_stack_ptr + 1                                              ; b474: e5 01       ..
    sty vm_stack_ptr + 1                                              ; b476: 84 01       ..
    tay                                                               ; b478: a8          .
    clc                                                               ; b479: 18          .
    txa                                                               ; b47a: 8a          .
    ...
    tya                                                               ; b47f: 98          .
    adc vm_pc + 1                                                     ; b480: 65 03       e.
    sta vm_pc + 1                                                     ; b482: 85 03       ..
...
.cb493
    clc                                                               ; b493: 18          .
    adc vm_stack_ptr                                                  ; b494: 65 00       e.
    tax                                                               ; b496: aa          .
    lda #0                                                            ; b497: a9 00       ..
    adc vm_stack_ptr + 1                                              ; b499: 65 01       e.
    tay                                                               ; b49b: a8          .
...
.something_03_handler
    ...
    lda vm_stack_ptr                                                  ; b7b5: a5 00       ..
    sta l0624                                                         ; b7b7: 8d 24 06    .$.
    lda vm_stack_ptr + 1                                              ; b7ba: a5 01       ..
...
.something_12_handler
    ...
    lda vm_pc + 1                                                     ; b7f9: a5 03       ..
    ldx vm_stack_ptr                                                  ; b7fb: a6 00       ..
    ldy vm_stack_ptr + 1                                              ; b7fd: a4 01       ..
    jsr sub_c859b                                                     ; b7ff: 20 9b 85     ..
    stx vm_pc                                                         ; b802: 86 02       ..
    sty vm_pc + 1                                                     ; b804: 84 03       ..
...
.cbc52
    ...
    tay                                                               ; bc70: a8          .
    adc vm_pc + 1                                                     ; bc71: 65 03       e.
    sta vm_pc + 1                                                     ; bc73: 85 03       ..
...
.cbca7
    ldx vm_stack_ptr                                                  ; bca7: a6 00       ..
    ldy vm_stack_ptr + 1                                              ; bca9: a4 01       ..
.cbcab
...
.cbd41
    ldx vm_stack_ptr                                                  ; bd41: a6 00       ..
    ldy vm_stack_ptr + 1                                              ; bd43: a4 01       ..
.loop_cbd45
...
.something_06_handler
    ...
    sta vm_base_ptr + 1                                               ; bd99: 85 1f       ..
    sbc vm_stack_ptr + 1                                              ; bd9b: e5 01       ..
...
.something_18_handler
    ...
    stx vm_stack_ptr                                                  ; bdd4: 86 00       ..
    sty vm_stack_ptr + 1                                              ; bdd6: 84 01       ..
...
.sub_cbe06
    sec                                                               ; be06: 38          8
    lda vm_stack_ptr                                                  ; be07: a5 00       ..
    sbc vm_pc                                                         ; be09: e5 02       ..
    sta l000c                                                         ; be0b: 85 0c       ..
    lda vm_stack_ptr + 1                                              ; be0d: a5 01       ..
    sbc vm_pc + 1                                                     ; be0f: e5 03       ..
...
.cbe46
    ...
    lda vm_stack_ptr                                                  ; be49: a5 00       ..
    sta l004c                                                         ; be4b: 85 4c       .L
    lda vm_stack_ptr + 1                                              ; be4d: a5 01       ..
    ...
    lda vm_stack_ptr + 1                                              ; be63: a5 01       ..
    pha                                                               ; be65: 48          H
    lda vm_stack_ptr                                                  ; be66: a5 00       ..
    pha                                                               ; be68: 48          H
...
.something_07_handler
    ...
    stx vm_stack_ptr                                                  ; be97: 86 00       ..
    stx l000e                                                         ; be99: 86 0e       ..
    sty vm_stack_ptr + 1                                              ; be9b: 84 01       ..
...
;     sub_cbf28
    ...
    assert operand_size_minus_1_table - 14 == &a726
    assert operand_size_minus_1_table - 145 == &a6a3
    assert operand_size_minus_1_table - 17 == &a723
    assert operand_size_minus_1_table - 24 == &a71c
    assert operand_size_minus_1_table - 29 == &a717
    assert operand_size_minus_1_table - 33 == &a713
    assert operand_size_minus_1_table - 38 == &a70e
    assert operand_size_minus_1_table - 5 == &a72f
    assert operand_size_minus_1_table - 51 == &a701
